      ...
      (i = function (n) {
        ...
        return (
          ...
          (n.open = function (t, e, i) {
            return (
              H(t) && o.trigger("request", { type: t, url: e, request: n }), s.apply(n, arguments)
            );
          })
        );
      }),
    ...
    if (null != F && A.ajax.trackWebSockets) {
      window.WebSocket = function (t, e) {
        ...
        return (
          ...
          H("socket") && o.trigger("request", { type: "socket", url: t, protocols: e, request: i }),
          i
        );
      };
      try {
  ...
  (X = Error),
    ...
    (nt.prototype.watch = function (t) {
      ...
      return (
        ...
        (e = t.request),
        (s = t.url),
        $(s) ? void 0 : ((i = new ("socket" === n ? d : p)(e)), this.elements.push(i))
      );
    }),
    (l = nt),
    (p = function (e) {
    ...
    (E = function () {
      var t, e, i, n, s, o, r, a;
      for (
        _.sources = R = [], e = 0, n = (o = ["ajax", "elements", "document", "eventLag"]).length;
        e < n;
        e++
      )
        !1 !== A[(t = o[e])] && R.push(new u[t](A[t]));
      for (i = 0, s = (a = null != (r = A.extraSources) ? r : []).length; i < s; i++)
  ...
  (function (t, e) {
    ...
    function d(t) {
      ...
      return (
        !b(t) &&
        !g(t) &&
        ("array" === i || 0 === e || ("number" == typeof e && 0 < e && e - 1 in t))
      );
    }
    (D.fn = D.prototype =
      {
                ...
                (n = t[e]),
                  "__proto__" !== e &&
                    ...
                    (h && n && (D.isPlainObject(n) || (s = Array.isArray(n)))
                      ? ((i = r[e]),
                        (o = s && !Array.isArray(i) ? [] : s || D.isPlainObject(i) ? i : {}),
                        (s = !1),
                        (r[e] = D.extend(h, o, n)))
                      : void 0 !== n && (r[e] = n));
          return r;
      ...
      D.extend({
        ...
        isPlainObject: function (t) {
          ...
          return !(
            ...
            ((e = n(t)) &&
              ("function" != typeof (i = v.call(e, "constructor") && e.constructor) ||
                r.call(i) !== h))
          );
        },
        ...
        makeArray: function (t, e) {
          var i = e || [];
          return (
            null != t && (d(Object(t)) ? D.merge(i, "string" == typeof t ? [t] : t) : l.call(i, t)),
            i
          );
        },
    ...
    var p = (function (i) {
      ...
      function at(t, e, i, n) {
        var s,
          ...
          u = e && e.ownerDocument,
          d = e ? e.nodeType : 9;
        if (((i = i || []), "string" != typeof t || !t || (1 !== d && 9 !== d && 11 !== d)))
          return i;
          ...
          return (
            n !== x &&
              ...
              (p.getById = ct(function (t) {
                return (
                  (a.appendChild(t).id = D), !x.getElementsByName || !x.getElementsByName(D).length
                );
              })),
              p.getById
                      ...
                      if (((l = [_ ? c.firstChild : c.lastChild]), _ && d)) {
                        ...
                        for (
                          ...
                          ((b ? r.nodeName.toLowerCase() !== u : 1 !== r.nodeType) ||
                            !++p ||
                            (d &&
                              ((s = (o = r[D] || (r[D] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[
                                f
                              ] = [T, p]),
                            r !== t));
          ...
          : function (t, e, i) {
              ...
              if (i) {
                ...
                for (; (t = t[l]); )
                  if (1 === t.nodeType || u)
                    if (
                      ((s = (o = t[D] || (t[D] = {}))[t.uniqueID] || (o[t.uniqueID] = {})),
          ...
          if ((e = y.relative[t[a].type])) c = [yt(wt(c), e)];
            ...
            if ((e = y.filter[t[a].type].apply(null, t[a].matches))[D]) {
              ...
              return xt(
                1 < a && wt(c),
                1 < a &&
                  bt(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(
                    B,
                    "$1"
                  ),
                e,
    ...
    ((D.fn.init = function (t, e, i) {
      ...
      if (
        !(n =
          "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : P.exec(t)) ||
        (!n[1] && e)
      )
      ...
      if (n[1]) {
        if (
          ...
          D.merge(this, D.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : k, !0)),
        ...
        if (!T.test(t))
          for (; n < s; n++)
            for (i = this[n]; i && i !== e; i = i.parentNode)
              if (
                i.nodeType < 11 &&
                (r ? -1 < r.index(i) : 1 === i.nodeType && D.find.matchesSelector(i, t))
              ) {
                o.push(i);
                break;
              }
      ...
      D.each(
        {
          ...
          contents: function (t) {
            return void 0 !== t.contentDocument
              ? t.contentDocument
              : (S(t, "template") && (t = t.content || t), D.merge([], t.childNodes));
          },
        },
        function (n, s) {
          D.fn[n] = function (t, e) {
            ...
            return (
              ...
              1 < this.length && (O[n] || D.uniqueSort(i), N.test(n) && i.reverse()),
              this.pushStack(i)
            );
          };
        }
      ...
      function s() {
        for (r = r || n.once, e = o = !0; l.length; h = -1)
          for (t = l.shift(); ++h < a.length; )
            !1 === a[h].apply(t[0], t[1]) && n.stopOnFalse && ((h = a.length), (t = !1));
                        ...
                        (e = t && ("object" == typeof t || "function" == typeof t) && t.then),
                          b(e)
                            ? a
                              ...
                              : (l++,
                                e.call(t, h(l, o, H, a), h(l, o, L, a), h(l, o, H, o.notifyWith)))
                        ...
                        : function () {
                            try {
                              ...
                              D.Deferred.exceptionHook && D.Deferred.exceptionHook(t, e.stackTrace),
                                l <= s + 1 &&
                                  (r !== L && ((i = void 0), (n = [t])), o.rejectWith(i, n));
                            }
                          };
                    s
                      ? e()
                      : (D.Deferred.getStackHook && (e.stackTrace = D.Deferred.getStackHook()),
                        x.setTimeout(e));
                  };
                }
    ...
    (D.fn.ready = function (t) {
      ...
      "complete" === k.readyState || ("loading" !== k.readyState && !k.documentElement.doScroll)
        ...
        : (k.addEventListener("DOMContentLoaded", j), x.addEventListener("load", j));
    ...
    (V.uid = 1),
      (V.prototype = {
        ...
        remove: function (t, e) {
          ...
          if (void 0 !== n) {
            if (void 0 !== e) {
              i = (e = Array.isArray(e) ? e.map(Y) : (e = Y(e)) in n ? [e] : e.match($) || [])
                .length;
              for (; i--; ) delete n[e[i]];
            }
        ...
        if (
          ...
          try {
            i =
              "true" === (s = i) ||
              ("false" !== s &&
                ("null" === s ? null : s === +s + "" ? +s : G.test(s) ? JSON.parse(s) : s));
          } catch (t) {}
          Q.set(t, e, i);
        } else i = void 0;
      return i;
            ...
            return "object" == typeof i
              ...
              : z(
                  ...
                  function (t) {
                    var e;
                    if (o && void 0 === t)
                      return void 0 !== (e = Q.get(o, i)) || void 0 !== (e = Z(o, i)) ? e : void 0;
                    this.each(function () {
                      Q.set(this, i, t);
                    });
                  },
        ...
        queue: function (t, e, i) {
          ...
          if (t)
            return (
              (e = (e || "fx") + "queue"),
              (n = X.get(t, e)),
              i && (!n || Array.isArray(i) ? (n = X.access(t, e, D.makeArray(i))) : n.push(i)),
              n || []
            );
        },
      ...
      D.fn.extend({
        ...
        promise: function (t, e) {
          ...
          for ("string" != typeof t && ((e = t), (t = void 0)), t = t || "fx"; a--; )
            (n = X.get(r[a], t + "queueHooks")) && n.empty && (s++, n.empty.add(i));
    ...
    function lt(t, e, i, n) {
      ...
      if (c && c[3] !== h) {
        for (l /= 2, h = h || c[3], c = +l || 1; r--; )
          D.style(t, e, c + h), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (r = 0), (c /= o);
    ...
    function ct(t, e) {
      for (var i, n, s, o, r, a, l = [], h = 0, c = t.length; h < c; h++)
        (n = t[h]).style &&
          ...
          e
            ? ("none" === i &&
                ((l[h] = X.get(n, "display") || null), l[h] || (n.style.display = "")),
              "" === n.style.display &&
                rt(n) &&
                (l[h] =
                  ((a = o = s = void 0),
    ...
    function yt(t, e, i, n, s) {
      for (
        var o, r, a, l, h, c, u = e.createDocumentFragment(), d = [], p = 0, f = t.length;
        p < f;
        p++
      )
        if ((o = t[p]) || 0 === o)
          ...
          for (
            ...
            for (
              ...
              (a.rnamespace && !1 !== o.namespace && !a.rnamespace.test(o.namespace)) ||
                ...
                (a.data = o.data),
                void 0 !==
                  (n = ((D.event.special[o.origType] || {}).handle || o.handler).apply(
                    s.elem,
                    l
                  )) &&
                  !1 === (a.result = n) &&
    ...
    function Lt(i, n, s, o) {
      ...
      if (
        ...
        for (a = (r = D.map(gt(t, "script"), Mt)).length; c < u; c++)
          (l = t),
            c !== d && ((l = D.clone(l, !0, !0)), a && D.merge(r, gt(l, "script"))),
            s.call(i[c], l, c);
        if (a)
            ...
            (l = r[c]),
              pt.test(l.type || "") &&
                ...
                (l.src && "module" !== (l.type || "").toLowerCase()
                  ? D._evalUrl &&
                    !l.noModule &&
                    D._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") })
    ...
    function Rt(t, e, i) {
      for (var n, s = e ? D.filter(e, t) : t, o = 0; null != (n = s[o]); o++)
        i || 1 !== n.nodeType || D.cleanData(gt(n)),
          n.parentNode && (i && st(n) && mt(gt(n, "script")), n.parentNode.removeChild(n));
      return t;
    }
    D.extend({
      ...
      clone: function (t, e, i) {
        ...
        if (!(_.noCloneChecked || (1 !== t.nodeType && 11 !== t.nodeType) || D.isXMLDoc(t)))
          for (r = gt(c), n = 0, s = (o = gt(t)).length; n < s; n++)
            (a = o[n]),
              "input" === (h = (l = r[n]).nodeName.toLowerCase()) && ut.test(a.type)
                ? (l.checked = a.checked)
        ...
        function (t, r) {
          D.fn[t] = function (t) {
            for (var e, i = [], n = D(t), s = n.length - 1, o = 0; o <= s; o++)
              (e = o === s ? this : this.clone(!0)), D(n[o])[r](e), l.apply(i, e.get());
        ...
        "margin" === i && (l += D.css(t, i + it[r], !0, s)),
          n
            ? ("content" === i && (l -= D.css(t, "padding" + it[r], !0, s)),
              "margin" !== i && (l -= D.css(t, "border" + it[r] + "Width", !0, s)))
      ...
      style: function (t, e, i, n) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var s,
            ...
            l = se.test(e),
            h = t.style;
          if ((l || (e = ie(a)), (r = D.cssHooks[e] || D.cssHooks[a]), void 0 === i))
        ...
        run: function (t) {
          ...
          return (
            this.options.duration
              ? (this.pos = e =
                  D.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration))
              : (this.pos = e = t),
      ...
      ((ce.propHooks = {
        _default: {
          ...
          set: function (t) {
            D.fx.step[t.prop]
              ? D.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType || (!D.cssHooks[t.prop] && null == t.elem.style[ie(t.prop)])
              ? (t.elem[t.prop] = t.now)
    ...
    function ye(t, e, i) {
      for (
        var n, s = (we.tweeners[e] || []).concat(we.tweeners["*"]), o = 0, r = s.length;
        o < r;
        o++
      )
    ...
    function we(o, t, e) {
      var i,
        ...
        l = function () {
          ...
          return (
            ...
            i < 1 && s ? e : (s || a.notifyWith(o, [h, 1, 0]), a.resolveWith(o, [h]), !1)
          );
        },
        h = a.promise({
          elem: o,
          ...
          stop: function (t) {
            ...
            return (
              t ? (a.notifyWith(o, [h, 1, 0]), a.resolveWith(o, [h, t])) : a.rejectWith(o, [h, t]),
              this
            );
          },
        }),
      ...
      for (
        ...
        if ((i = we.prefilters[n].call(h, o, c, h.opts)))
          return b(i.stop) && (D._queueHooks(h.elem, h.opts.queue).stop = i.stop.bind(i)), i;
      return (
        D.map(c, ye, h),
    ...
    (D.Animation = D.extend(we, {
      ...
      tweener: function (t, e) {
        for (var i, n = 0, s = (t = b(t) ? ((e = t), ["*"]) : t.match($)).length; n < s; n++)
          (i = t[n]), (we.tweeners[i] = we.tweeners[i] || []), we.tweeners[i].unshift(e);
      },
      prefilters: [
        function (t, e, i) {
          var n,
          ...
          if ((l = !D.isEmptyObject(e)) || !D.isEmptyObject(p))
            for (n in (u &&
              ...
              "none" === (c = D.css(t, "display")) &&
                (h
                  ? (c = h)
                  : (ct([t], !0), (h = t.style.display || h), (c = D.css(t, "display")), ct([t]))),
        ...
        attr: function (t, e, i) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return void 0 === t.getAttribute
              ? D.prop(t, e, i)
              : ((1 === o && D.isXMLDoc(t)) ||
                  (s = D.attrHooks[e.toLowerCase()] || (D.expr.match.bool.test(e) ? Ce : void 0)),
                void 0 !== i
                  ? null === i
      ...
      D.each(D.expr.match.bool.source.match(/\w+/g), function (t, e) {
        ...
        xe[e] = function (t, e, i) {
          var n,
            ...
            o = e.toLowerCase();
          return (
            i || ((s = xe[o]), (xe[o] = n), (n = null != r(t, e, i) ? o : null), (xe[o] = s)), n
          );
        };
      });
          ...
          ? ((s = b(i)),
            this.each(function (t) {
              ...
              1 === this.nodeType &&
                ...
                ((n = D.valHooks[this.type] || D.valHooks[this.nodeName.toLowerCase()]) &&
                  "set" in n &&
      ...
      D.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (var i, n, s = t.options, o = D.makeArray(e), r = s.length; r--; )
                ((n = s[r]).selected = -1 < D.inArray(D.valHooks.option.get(n), o)) && (i = !0);
      ...
      trigger: function (t, e, i, n) {
        ...
        if (
          ...
          3 !== i.nodeType &&
            ...
            (l = p.indexOf(":") < 0 && "on" + p),
            ((t = t[D.expando] ? t : new D.Event(p, "object" == typeof t && t)).isTrigger = n
              ? 2
              : 3),
            (t.namespace = f.join(".")),
          ...
          if (!n && !c.noBubble && !g(i)) {
            for (a = c.delegateType || p, Pe.test(a + p) || (o = o.parentNode); o; o = o.parentNode)
              d.push(o), (r = o);
          ...
          for (s = 0; (o = d[s++]) && !t.isPropagationStopped(); )
            (u = o),
              ...
              (h = l && o[l]) &&
                h.apply &&
                K(o) &&
                ((t.result = h.apply(o, e)), !1 === t.result && t.preventDefault());
          return (
            (t.type = p),
            n ||
    ...
    D.parseXML = function (t) {
      ...
      return (
        (e && !e.getElementsByTagName("parsererror").length) || D.error("Invalid XML: " + t), e
      );
    };
    var $e = /\[\]$/,
      He = /\r?\n/g,
    ...
    function We(i, t, n, s) {
      ...
      if (Array.isArray(t))
        D.each(t, function (t, e) {
          n || $e.test(i)
            ? s(i, e)
            : We(i + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, n, s);
        });
        ...
        ajax: function (t, e) {
            ...
            C = {
              ...
              getResponseHeader: function (t) {
                ...
                if (f) {
                  if (!i)
                    for (i = {}; (e = qe.exec(d)); )
                      i[e[1].toLowerCase() + " "] = (i[e[1].toLowerCase() + " "] || []).concat(
                        e[2]
                      );
                  e = i[t.toLowerCase() + " "];
                }
              ...
              setRequestHeader: function (t, e) {
                return (
                  null == f && ((t = a[t.toLowerCase()] = a[t.toLowerCase()] || t), (r[t] = e)),
                  this
                );
              },
          ...
          m.hasContent
            ...
            : ((o = m.url.slice(u.length)),
              ...
              !1 === m.cache &&
                ((u = u.replace(ze, "$1")), (o = (Me.test(u) ? "&" : "?") + "_=" + Oe++ + o)),
              (m.url = u + o)),
          m.ifModified &&
            (D.lastModified[u] && C.setRequestHeader("If-Modified-Since", D.lastModified[u]),
          ...
          C.setRequestHeader(
            ...
            m.dataTypes[0] && m.accepts[m.dataTypes[0]]
              ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Ve + "; q=0.01" : "")
              : m.accepts["*"]
          ),
          m.headers))
          ...
          function h(t, e, i, n) {
            ...
            f ||
              ...
              s
                ? (m.ifModified &&
                    ((l = C.getResponseHeader("Last-Modified")) && (D.lastModified[u] = l),
        ...
        if (r || "jsonp" === t.dataTypes[0])
          return (
            ...
            r
              ...
              : !1 !== t.jsonp && (t.url += (Me.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
      ...
      (D.parseHTML = function (t, e, i) {
        return "string" != typeof t
          ...
          : ("boolean" == typeof e && ((i = e), (e = !1)),
            e ||
              (_.createHTMLDocument
                ? (((n = (e = k.implementation.createHTMLDocument("")).createElement("base")).href =
                    k.location.href),
            ...
            (s = E.exec(t))
              ? [e.createElement(s[1])]
              : ((s = yt([t], e, o)), o && o.length && D(o).remove(), D.merge([], s.childNodes)));
        var n, s, o;
      }),
          ...
          if (this[0]) {
            ...
            if ("fixed" === D.css(n, "position")) e = n.getBoundingClientRect();
              ...
              for (
                ...
                t && (t === i.body || t === i.documentElement) && "static" === D.css(t, "position");
      ...
      D.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (e, s) {
        ...
        D.fn[e] = function (t) {
          return z(
            ...
            function (t, e, i) {
              var n;
              if ((g(t) ? (n = t) : 9 === t.nodeType && (n = t.defaultView), void 0 === i))
                return n ? n[s] : t[e];
  ...
  (function (t) {
      ...
      (x.Widget.prototype = {
        ...
        option: function (t, e) {
          ...
          if ("string" == typeof t)
            if (((o = {}), (t = (i = t.split(".")).shift()), i.length)) {
              for (n = o[t] = x.widget.extend({}, this.options[t]), s = 0; i.length - 1 > s; s++)
                (n[i[s]] = n[i[s]] || {}), (n = n[i[s]]);
        ...
        _on: function (r, a, t) {
          ...
          "boolean" != typeof r && ((t = a), (a = r), (r = !1)),
            ...
            x.each(t, function (t, e) {
              function i() {
                return r || (!0 !== h.options.disabled && !x(this).hasClass("ui-state-disabled"))
        ...
        _trigger: function (t, e, i) {
          ...
          return (
            ...
            !(
              (x.isFunction(o) && !1 === o.apply(this.element[0], [e].concat(i))) ||
        ...
        flip: {
          left: function (t, e) {
            var i,
              ...
              p = -2 * e.offset[0];
            h < 0
              ? ((i = t.left + u + d + p + e.collisionWidth - r - o) < 0 || k(h) > i) &&
                (t.left += u + d + p)
              : 0 < c &&
                (0 < (n = t.left - e.collisionPosition.marginLeft + u + d + p - a) || c > k(n)) &&
                (t.left += u + d + p);
          },
          top: function (t, e) {
            var i,
              ...
              p = -2 * e.offset[1];
            h < 0
              ? ((n = t.top + u + d + p + e.collisionHeight - r - o) < 0 || k(h) > n) &&
                (t.top += u + d + p)
              : 0 < c &&
                (0 < (i = t.top - e.collisionPosition.marginTop + u + d + p - a) || c > k(i)) &&
                (t.top += u + d + p);
          },
        },
        flipfit: {
      ...
      return (
        ...
        j($, function (t, e) {
          var i,
            ...
            o = e.space || "rgba";
          return s
            ? ((i = a[o](s)), (a[L[o].cache] = i[L[o].cache]), (l = a._rgba = i._rgba), !1)
            : N;
        }),
            ...
            j(i.props, function (t, e) {
              ...
              null !== s &&
                (null === n
                  ? (h[i] = s)
                  : (o.mod &&
                      (o.mod / 2 < s - n ? (n += o.mod) : o.mod / 2 < n - s && (n -= o.mod)),
                    (h[i] = Q((s - n) * r + n, e))));
            }),
            this[e](h)
          );
        ...
        toggleClass:
          ...
          function (t, e, i, n, s) {
            return "boolean" == typeof e || void 0 === e
              ? i
                ? x.effects.animateClass.call(this, e ? { add: t } : { remove: t }, i, n, s)
    ...
    x.effects.define("blind", "hide", function (t, e) {
      ...
      x.effects.define("bounce", function (t, e) {
        ...
        for (
          ...
          ((i = {})[g] = (m ? "-=" : "+=") + c),
            ...
            (c = a ? 2 * c : c / 2);
        a && (((i = { opacity: 0 })[g] = (m ? "-=" : "+=") + c), o.animate(i, p, f)),
          o.queue(e),
      ...
      x.effects.define("explode", "hide", function (t, e) {
        function i() {
          m.push(this),
            m.length === h * c && (u.css({ visibility: "visible" }), x(m).remove(), e());
        }
        var n,
          s,
          o,
          ...
          for (r = p.top + n * g, l = n - (h - 1) / 2, s = 0; s < c; s++)
            (o = p.left + s * f),
              ...
              u
                ...
                .animate(
                  { left: o + (d ? 0 : a * f), top: r + (d ? 0 : l * g), opacity: d ? 1 : 0 },
                  t.duration || 500,
                  t.easing,
                  i
                );
      ...
      x.effects.define("scale", function (t, e) {
        var i = x(this),
          n = t.mode,
          s =
            parseInt(t.percent, 10) || (0 === parseInt(t.percent, 10) || "effect" !== n ? 0 : 100),
          o = x.extend(
            !0,
            {
      ...
      x.effects.define("pulsate", "show", function (t, e) {
        var i = x(this),
          ...
          h = 1,
          c = i.queue().length;
        for ((!s && i.is(":visible")) || (i.css("opacity", 0).show(), (l = 1)); h < r; h++)
      ...
      (x.ui.focusable = function (t, e) {
        ...
        return "area" === a
          ...
          : (/^(input|select|textarea|button|object)$/.test(a)
              ? (o = !t.disabled) && (r = x(t).closest("fieldset")[0]) && (o = !r.disabled)
              : (o = ("a" === a && t.href) || e),
            o &&
              x(t).is(":visible") &&
              (function (t) {
      ...
      x.widget("ui.accordion", {
        ...
        _activate: function (t) {
          ...
          e !== this.active[0] &&
            ((e = e || this.active[0]),
            this._eventHandler({ target: e, currentTarget: e, preventDefault: x.noop }));
        },
                      ...
                      (e.now = Math.round(t)),
                        "height" !== e.prop
                          ...
                          : "content" !== a.options.heightStyle &&
                            ((e.now = Math.round(s - i.outerHeight() - l)), (l = 0));
                    },
                  }))
            ...
            this._on({
              ...
              blur: function (t) {
                this._delay(function () {
                  x.contains(this.element[0], x.ui.safeActiveElement(this.document[0])) ||
                    this.collapseAll(t);
                });
              },
              keydown: "_keydown",
              ...
              (o = !1),
                ...
                (e =
                  s && -1 !== e.index(this.active.next())
                    ...
                    : e).length ||
                  ((n = String.fromCharCode(t.keyCode)), (e = this._filterMenuItems(n))),
                e.length
                  ? (this.focus(t, e),
      ...
      x.extend(t.prototype, {
        ...
        _attachments: function (t, e) {
          ...
          e.append && e.append.remove(),
            o &&
              ((e.append = x("<span class='" + this._appendClass + "'>" + o + "</span>")),
                ...
                return (
                  (n = x(
                    "td." +
                      ...
                      ")",
                    s.dpDiv
                  ))[0] && x.datepicker._selectDay(t.target, s.selectedMonth, s.selectedYear, n[0]),
        ...
        _doKeyPress: function (t) {
          ...
          return x.datepicker._get(n, "constrainInput")
            ? ((e = x.datepicker._possibleChars(x.datepicker._get(n, "dateFormat"))),
          ...
          "input" !== (t = t.target || t).nodeName.toLowerCase() &&
            ...
            x.datepicker._isDisabledDatepicker(t) ||
              ...
              !1 !== (n = (i = x.datepicker._get(e, "beforeShow")) ? i.apply(t, [t, e]) : {}) &&
                ...
                e.dpDiv.css({
                  position:
                    x.datepicker._inDialog && x.blockUI ? "static" : s ? "fixed" : "absolute",
                  display: "none",
                  left: o.left + "px",
                  top: o.top + "px",
                }),
        ...
        _findPos: function (t) {
          for (
            ...
            t && ("hidden" === t.type || 1 !== t.nodeType || x.expr.filters.hidden(t));
          ...
          !o ||
            ...
            (this._datepickerShowing &&
              ...
              x.effects && (x.effects.effect[e] || x.effects[e])
                ...
                : o.dpDiv["slideDown" === e ? "slideUp" : "fadeIn" === e ? "fadeOut" : "hide"](
                    e ? i : null,
                    n
                  ),
              e || n(),
        ...
        _adjustDate: function (t, e, i) {
          ...
          this._isDisabledDatepicker(n[0]) ||
            (this._adjustInstDate(s, e + ("M" === i ? this._get(s, "showCurrentAtPos") : 0), i),
        ...
        parseDate: function (i, o, t) {
          ...
          if (
            (c = this._daylightSavingAdjust(new Date(_, b - 1, y))).getFullYear() !== _ ||
            c.getMonth() + 1 !== b ||
            c.getDate() !== y
          )
            throw "Invalid date";
            ...
            s =
              null == t || "" === t
                ...
                ? (function (t) {
                    ...
                    for (
                      var e =
                          (t.toLowerCase().match(/^c/) ? x.datepicker._getDate(a) : null) ||
                          new Date(),
                        i = e.getFullYear(),
                        n = e.getMonth(),
                        s = e.getDate(),
          ...
          if ((Z < 0 && ((Z += 12), tt--), J))
            for (
              e = this._daylightSavingAdjust(
                new Date(J.getFullYear(), J.getMonth() - Y[0] * Y[1] + 1, J.getDate())
              ),
                e = G && e < G ? G : e;
          ...
          for (
            ...
            for (x = "", this.maxRows = 4, k = 0; Y[1] > k; k++) {
              ...
              for (
                ...
                E +=
                  "<th scope='col'" +
                  (5 <= (w + c + 6) % 7 ? " class='ui-datepicker-week-end'" : "") +
                  "><span title='" +
                  d[(I = (w + c) % 7)] +
                  "'>" +
                  p[I] +
                ...
                for (
                  ...
                  (L = m ? m.apply(t.input ? t.input[0] : null, [M]) : [!0, ""]),
                    ...
                    (H +=
                      ...
                      ((M.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent) ||
                      (b.getTime() === M.getTime() && b.getTime() === D.getTime())
                        ? " " + this._dayOverClass
                        : "") +
                      ...
                      (R && !v
                        ...
                        : " " +
                          L[1] +
                          (M.getTime() === Q.getTime() ? " " + this._currentClass : "") +
                          (M.getTime() === j.getTime() ? " ui-datepicker-today" : "")) +
                      "'" +
      ...
      (x.fn.datepicker = function (t) {
        ...
        return "string" != typeof t || ("isDisabled" !== t && "getDate" !== t && "widget" !== t)
          ? "option" === t && 2 === arguments.length && "string" == typeof arguments[1]
            ...
            : this.each(function () {
                "string" == typeof t
                  ? x.datepicker["_" + t + "Datepicker"].apply(x.datepicker, [this].concat(e))
    ...
    x(document).on("mouseup", function () {
        ...
        _mouseInit: function () {
          ...
          this.element
            ...
            .on("click." + this.widgetName, function (t) {
              return !0 === x.data(t.target, e.widgetName + ".preventClickEvent")
      ...
      x.widget("ui.draggable", x.ui.mouse, {
        ...
        _mouseStop: function (t) {
          ...
          return (
            ...
            (x.isFunction(this.options.revert) && this.options.revert.call(this.element, i))
        ...
        _createHelper: function (t) {
          ...
          return (
            n.parents("body").length ||
              n.appendTo("parent" === e.appendTo ? this.element[0].parentNode : e.appendTo),
            ...
            n.containment
              ? "window" === n.containment
                ...
                ? void (this.containment = [
                    0,
                    0,
                    x(s).width() - this.helperProportions.width - this.margins.left,
        ...
        start: function (e, t, i) {
          ...
          (i.sortables = []),
            x(i.options.connectToSortable).each(function () {
              ...
              t &&
                !t.options.disabled &&
                (i.sortables.push(t), t.refreshPositions(), t._trigger("activate", e, n));
            });
        },
        stop: function (e, t, i) {
          var n = x.extend({}, t, { item: i.element });
          ...
          o !== r && "HTML" !== o.tagName
            ...
            : ((n.axis && "x" === n.axis) ||
                (t.pageY - x(r).scrollTop() < n.scrollSensitivity
                  ...
                  : x(window).height() - (t.pageY - x(r).scrollTop()) < n.scrollSensitivity &&
                    (s = x(r).scrollTop(x(r).scrollTop() + n.scrollSpeed))),
              (n.axis && "y" === n.axis) ||
                (t.pageX - x(r).scrollLeft() < n.scrollSensitivity
                  ? (s = x(r).scrollLeft(x(r).scrollLeft() - n.scrollSpeed))
                  : x(window).width() - (t.pageX - x(r).scrollLeft()) < n.scrollSensitivity &&
                    (s = x(r).scrollLeft(x(r).scrollLeft() + n.scrollSpeed)))),
      ...
      x.ui.plugin.add("draggable", "snap", {
        start: function (t, e, i) {
          var n = i.options;
          (i.snapElements = []),
            x(n.snap.constructor !== String ? n.snap.items || ":data(ui-draggable)" : n.snap).each(
              function () {
                var t = x(this),
                  e = t.offset();
                this !== i.element[0] &&
        ...
        drag: function (t, e, i) {
          ...
          for (u = i.snapElements.length - 1; 0 <= u; u--)
            (l = (a = i.snapElements[u].left - i.margins.left) + i.snapElements[u].width),
              ...
              _ < h - f ||
              c + f < v ||
              !x.contains(i.snapElements[u].item.ownerDocument, i.snapElements[u].item)
                ...
                : ("inner" !== p.snapMode &&
                    ...
                    s &&
                      (e.position.top = i._convertPositionTo("relative", { top: c, left: 0 }).top),
                    o &&
                  ...
                  "outer" !== p.snapMode &&
                    ...
                    (r = f >= Math.abs(l - m)),
                    n &&
                      (e.position.top = i._convertPositionTo("relative", { top: h, left: 0 }).top),
                    s &&
                      (e.position.top = i._convertPositionTo("relative", {
        ...
        start: function (t, e, i) {
          var n,
            ...
            o = x.makeArray(x(s.stack)).sort(function (t, e) {
              return (
                (parseInt(x(t).css("zIndex"), 10) || 0) - (parseInt(x(e).css("zIndex"), 10) || 0)
              );
            });
          o.length &&
      ...
      x.widget("ui.resizable", x.ui.mouse, {
        ...
        _mouseStart: function (t) {
          ...
          return (
            ...
            s.containment &&
              ((e += x(s.containment).scrollLeft() || 0), (i += x(s.containment).scrollTop() || 0)),
        ...
        _mouseStop: function (t) {
          ...
          return (
            this._helper &&
              ...
              (r =
                parseFloat(h.element.css("left")) + (h.position.left - h.originalPosition.left) ||
                null),
              (a =
                parseFloat(h.element.css("top")) + (h.position.top - h.originalPosition.top) ||
                null),
        ...
        stop: function (e) {
          var i = x(this).resizable("instance"),
            ...
            l =
              ...
              null,
            h =
              parseFloat(i.element.css("top")) + (i.position.top - i.originalPosition.top) || null;
          i.element.animate(x.extend(a, h && l ? { top: h, left: l } : {}), {
            ...
            step: function () {
              ...
              n && n.length && x(n[0]).css({ width: t.width, height: t.height }),
                i._updateCache(t),
      ...
      x.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (t) {
          ...
          u[0] !== document && /static/.test(u.css("position")) && (c = a),
            l.left < (o._helper ? a.left : 0) &&
              ((o.size.width =
                o.size.width + (o._helper ? o.position.left - a.left : o.position.left - c.left)),
              h && ((o.size.height = o.size.width / o.aspectRatio), (d = !1)),
              (o.position.left = r.helper ? a.left : 0)),
            l.top < (o._helper ? a.top : 0) &&
              ((o.size.height =
                o.size.height + (o._helper ? o.position.top - a.top : o.position.top)),
            ...
            (e = Math.abs(
              o.sizeDiff.width + (o._helper ? o.offset.left - c.left : o.offset.left - a.left)
            )),
            (i = Math.abs(
              o.sizeDiff.height + (o._helper ? o.offset.top - c.top : o.offset.top - a.top)
            )),
        ...
        stop: function () {
          ...
          t._helper &&
            ...
            x(this).css({ left: r.left - n.left - i.left, width: a, height: l }),
            t._helper &&
              !e.animate &&
      ...
      x.widget("ui.dialog", {
        ...
        _setOption: function (t, e) {
          ...
          "disabled" !== t &&
            ...
            "resizable" === t &&
              ((n = s.is(":data(ui-resizable)")) && !e && s.resizable("destroy"),
        ...
        t: for (i = 0; s.length > i; i++)
          if (
            !(
              ...
              (t && !s[i].accept.call(s[i].element[0], t.currentItem || t.element))
            )
          ) {
                  ...
                  return e
                    ? ((t = (!i.metaKey && !i.ctrlKey) || !e.$element.hasClass("ui-selected")),
                      ...
                      (e.selected = t)
                        ...
                        : n._trigger("unselecting", i, { unselecting: e.element }),
                      !1)
                    : void 0;
                }));
        },
            ...
            return (
              ...
              this.selectees.each(function () {
                ...
                t &&
                  ...
                  "touch" === o.tolerance
                    ? (e = !(i.left > l || r > i.right || i.top > h || a > i.bottom))
                    : "fit" === o.tolerance &&
                      (e = i.left > r && l > i.right && i.top > a && h > i.bottom),
                  e
                    ? (t.selected && (s._removeClass(t.$element, "ui-selected"), (t.selected = !1)),
                      t.unselecting &&
                        (s._removeClass(t.$element, "ui-unselecting"), (t.unselecting = !1)),
                      t.selecting ||
                    ...
                    : (t.selecting &&
                        ((n.metaKey || n.ctrlKey) && t.startselected
                          ...
                          : (s._removeClass(t.$element, "ui-selecting"),
                            (t.selecting = !1),
                            t.startselected &&
                              (s._addClass(t.$element, "ui-unselecting"), (t.unselecting = !0)),
                ...
                .menu({
                  ...
                  focus: function (t, e) {
                    ...
                    null != n.focusIndex &&
                      ...
                      (n._trigger("focus", t, { item: i }), n.isOpen || n._select(i, t)),
            ...
            this.isOpen
              ...
              (n =
                "first" === t || "last" === t
                  ...
                  : i[t + "All"](s).eq(0)).length && this.menuInstance.focus(e, n);
          },
        ...
        _mouseCapture: function (t) {
          ...
          return (
            ...
            this.handles.each(function (t) {
              ...
              (e < n || (n === e && (t === l._lastChangedValue || l.values(t) === h.min))) &&
                ((n = e), (s = x(this)), (o = t));
            }),
            !1 !== this._start(t, o) &&
                ...
                ("horizontal" === this.orientation
                  ...
                  : ((e = this.elementSize.height),
                    t.y -
                      ...
                      (this._clickOffset ? this._clickOffset.top : 0))) / e) && (i = 1),
            i < 0 && (i = 0),
        ...
        _setOption: function (t, e) {
          ...
          switch (
            ...
            case "value":
              ...
              break;
            case "values":
              for (this._animateOff = !0, this._refreshValue(), i = n - 1; 0 <= i; i--)
                this._change(null, i);
              this._animateOff = !1;
              break;
            case "step":
                ...
                (i = ((a.values(t) - a._valueMin()) / (a._valueMax() - a._valueMin())) * 100),
                  ...
                  !0 === a.options.range &&
                    ("horizontal" === a.orientation
                      ? (0 === t &&
                          a.range.stop(1, 1)[l ? "animate" : "css"]({ left: i + "%" }, r.animate),
                        1 === t &&
                      ...
                      : (0 === t &&
                          a.range.stop(1, 1)[l ? "animate" : "css"]({ bottom: i + "%" }, r.animate),
                        1 === t &&
                          a.range[l ? "animate" : "css"](
                            { height: i - e + "%" },
                            { queue: !1, duration: r.animate }
                ...
                (s = x.data(n[i], this.widgetFullName)) &&
                  ...
                  (c.push([
                    x.isFunction(s.options.items)
                      ? s.options.items.call(s.element[0], t, { item: this.currentItem })
          ...
          for (e = c.length - 1; 0 <= e; e--)
            for (o = c[e][1], i = 0, l = (r = c[e][0]).length; i < l; i++)
              (a = x(r[i])).data(this.widgetName + "-item", o),
                h.push({ item: a, instance: o, width: 0, height: 0, left: 0, top: 0 });
        },
          ...
          (s.placeholder && s.placeholder.constructor !== String) ||
            ...
            (s.placeholder = {
              element: function () {
                ...
                return (
                  i
                    ._addClass(e, "ui-sortable-placeholder", n || i.currentItem[0].className)
        ...
        _createHelper: function (t) {
          ...
          return (
            i.parents("body").length ||
              x(
                "parent" !== e.appendTo ? e.appendTo : this.currentItem[0].parentNode
              )[0].appendChild(i[0]),
        ...
        _events: {
          ...
          "mousedown .ui-spinner-button": function (t) {
            ...
            (i =
              ...
              !1 !== this._start(t) &&
                this._repeat(null, x(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1, t);
          },
          "mouseup .ui-spinner-button": "_stop",
          "mouseenter .ui-spinner-button": function (t) {
            return x(t.currentTarget).hasClass("ui-state-active")
              ? !1 !== this._start(t) &&
                  void this._repeat(null, x(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1, t)
              : void 0;
          },
      ...
      x.widget("ui.tabs", {
          ...
          (this.running = !1),
            ...
            x.isArray(t.disabled) &&
              (t.disabled = x
                ...
                .sort()),
            (this.active =
              !1 !== this.options.active && this.anchors.length ? this._findActive(t.active) : x()),
            this._refresh(),
        ...
        _findNextTab: function (t, e) {
          for (
            ...
            -1 !== x.inArray((i < t && (t = 0), t < 0 && (t = i), t), this.options.disabled);
          ...
          (this.tablist = this._getList().attr("role", "tablist")),
            ...
            this.anchors.each(function (t, e) {
              ...
              l._isLocal(e)
                ...
                : ((i = "#" + (s = r.attr("aria-controls") || x({}).uniqueId()[0].id)),
                  (n = l.element.find(i)).length ||
                    (n = l._createPanel(s)).insertAfter(l.panels[t - 1] || l.tablist),
        ...
        _toggle: function (t, e) {
          ...
          function n() {
            s._addClass(e.newTab.closest("li"), "ui-tabs-active", "ui-state-active"),
              o.length && s.options.show ? s._show(o, s.options.show, i) : (o.show(), i());
          }
          var s = this,
            o = e.newPanel,
            r = e.oldPanel;
            ...
            t &&
              ...
              e.parents().each(function () {
                ...
                e.data("ui-tooltip-open") &&
                  (((t = x.Event("blur")).target = t.currentTarget = this), i.close(t, !0)),
                  e.attr("title") &&
                    (e.uniqueId(),
  ...
  (function (t, e) {
              ...
              if ("radio" === n.type)
                ...
                "checkbox" === n.type
                  ? "LABEL" === this._element.tagName &&
                    ...
                    (t = !1)
                  : (t = !1);
              t && ((n.checked = !this._element.classList.contains(C)), f(n).trigger("change")),
                n.focus(),
                (e = !1);
            }
          }
          ...
          if (
            ((s =
              t === $
                ...
                : ((i = "carousel-item-right"), (n = "carousel-item-prev"), "right")),
            l && f(l).hasClass(R))
          )
            this._isSliding = !1;
            ...
            if ((f(this._element).trigger(e), !e.isDefaultPrevented())) {
              ...
              if (0 < n)
                for (var s = 0; s < n; s++) {
                  ...
                  null !== r &&
                    (f([].slice.call(document.querySelectorAll(r))).hasClass(G) ||
    ...
    function gt(t) {
      ...
      return n && "BODY" !== n && "HTML" !== n
        ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === lt(i, "position")
          ? gt(i)
          : i
        : t
    ...
    function vt(t, e) {
      ...
      if ((t !== l && e !== l) || n.contains(s))
        return "BODY" === (a = (r = l).nodeName) || ("HTML" !== a && gt(r.firstElementChild) !== r)
          ? gt(l)
          : l;
      var h = mt(t);
    ...
    function _t(t, e) {
      var i =
          "top" === (1 < arguments.length && void 0 !== e ? e : "top") ? "scrollTop" : "scrollLeft",
        n = t.nodeName;
    ...
    function It(t, e, i, n, s) {
      ...
      if ("viewport" === n)
        ...
        var l = void 0;
        "scrollParent" === n
          ? "BODY" === (l = ct(ht(e))).nodeName && (l = t.ownerDocument.documentElement)
              ...
              var h = n.priority,
                ...
                u = {
                  primary: function (t) {
                    var e = c[t];
                    return (
                      c[t] < l[t] && !n.escapeWithReference && (e = Math.max(c[t], l[t])),
                      xt({}, t, e)
                    );
                  },
                  secondary: function (t) {
                    ...
                    return (
                      c[t] > l[t] &&
                        ...
                        (i = Math.min(c[e], l[t] - ("right" === t ? c.width : c.height))),
                      xt({}, e, i)
                    );
                  },
                };
          ...
          arrow: {
            ...
            fn: function (t, e) {
              ...
              return (
                ...
                (t.arrowElement = n),
                (t.offsets.arrow = (xt((i = {}), u, Math.round(b)), xt(i, d, ""), i)),
                t
              );
            },
            element: "[x-arrow]",
              ...
              return function () {
                this.state.eventsEnabled ||
                  (this.state = (function (t, e, i) {
                    (e.updateBound = i),
                      Wt(t).addEventListener("resize", e.updateBound, { passive: !0 });
                    var n = ct(t);
                    return (
                      (function t(e, i, n, s) {
      ...
      ge =
        ...
        (me._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new me(this, "object" == typeof e ? e : null)), f(this).data(ie, t)),
              "string" == typeof e)
            ) {
        ...
        (me._clearMenus = function (t) {
          if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
            for (
              var e = [].slice.call(document.querySelectorAll(ue)), i = 0, n = e.length;
              i < n;
              i++
            ) {
          ...
          if (
            (/input|textarea/i.test(t.target.tagName)
              ? !(
                  32 === t.which ||
                  (27 !== t.which &&
                    ((40 !== t.which && 38 !== t.which) || f(t.target).closest(de).length))
                )
              : re.test(t.which)) &&
          ...
          n = function (t) {
            ...
            n.forEach(function (t) {
              !(function (t, e) {
                ...
                if (-1 !== e.indexOf(i))
                  return (
                    -1 === Oe.indexOf(i) || Boolean(t.nodeValue.match(Me) || t.nodeValue.match($e))
                  );
                for (
      ...
      Ze =
        ...
        (Le.setElementContent = function (t, e) {
          "object" != typeof e || (!e.nodeType && !e.jquery)
            ? this.config.html
              ? (this.config.sanitize && (e = He(e, this.config.whiteList, this.config.sanitizeFn)),
                t.html(e))
              : t.text(e)
            : this.config.html
        ...
        (Le._getOffset = function () {
          ...
          return (
            "function" == typeof this.config.offset
              ? (t.fn = function (t) {
                  return (
                    (t.offsets = r({}, t.offsets, {}, e.config.offset(t.offsets, e.element) || {})),
                    t
                  );
                })
        ...
        (ti._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              ...
              (t || ((t = new ti(this, e)), f(this).data(We, t)), "string" == typeof i)
            ) {
              if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
              t[i]();
            }
        ...
        return (
          ...
          (n._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (t || !/dispose|hide/.test(i)) &&
                (t || ((t = new n(this, e)), f(this).data(ii, t)), "string" == typeof i)
              ) {
                if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                t[i]();
              }
      ...
      xi =
        ...
        (ki._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new ki(this, "object" == typeof e && e)), f(this).data(pi, t)),
              "string" == typeof e)
            ) {
              if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
              t[e]();
    ...
    var Mi,
      ...
      qi =
        ...
        (Mi._getConfig = function (t) {
          return (
            (t = r({}, zi, {}, f(this._element).data(), {}, "object" == typeof t && t ? t : {})),
        ...
        (Bi._jQueryInterface = function (i) {
          return this.each(function () {
            var t = f(this),
              e = t.data(Hi);
            if (
              (e || ((e = new Bi(this, "object" == typeof i && i)), t.data(Hi, e)),
              "string" == typeof i)
            ) {
              if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
              e[i](this);
        ...
        return (
          this.each(function () {
            ...
            function n(t, e, i) {
              ...
              e &&
                ((e =
                  parseInt(v.css("top")) + ((t * parseInt(w.wheelStep)) / 100) * v.outerHeight()),
                (e = Math.min(Math.max(e, 0), n)),
                (e = 0 < t ? Math.ceil(e) : Math.floor(e)),
                v.css({ top: e + "px" })),
                (e =
                  (d = parseInt(v.css("top")) / (g.outerHeight() - v.outerHeight())) *
            ...
            function s() {
              i(),
                ...
                d == ~~d
                  ? ((f = w.allowPageScroll),
                    p != d && g.trigger("slimscroll", 0 == ~~d ? "top" : "bottom"))
                  : (f = !1),
                (p = d),
                u >= g.outerHeight()
                  ? (f = !0)
                  : (v.stop(!0, !0).fadeIn("fast"), w.railVisible && _.stop(!0, !0).fadeIn("fast"));
            }
            function o() {
              w.alwaysVisible ||
            ...
            if (g.parent().hasClass(w.wrapperClass)) {
              ...
              if ((i(), C.isPlainObject(y))) {
                if ("height" in y && "auto" == y.height) {
                  ...
                  "height" in y &&
                    ((b = y.height), g.parent().css("height", b), g.css("height", b));
                ...
                g.bind("touchmove", function (t) {
                  f || t.originalEvent.preventDefault(),
                    t.originalEvent.touches.length &&
                      (n((c - t.originalEvent.touches[0].pageY) / w.touchScrollStep, !0),
                      (c = t.originalEvent.touches[0].pageY));
                }),
                i(),
                "bottom" === w.start
                  ? (v.css({ top: g.outerHeight() - v.outerHeight() }), n(0, !0))
                  : "top" !== w.start &&
                    (n(C(w.start).position().top, null, !0), w.alwaysVisible || v.hide()),
  ...
  (function (t) {
    ...
    return (function t(l) {
      ...
      function e(t, e) {
        if ("undefined" != typeof document) {
          for (
            var i = {}, n = document.cookie ? document.cookie.split("; ") : [], s = 0;
            s < n.length;
            s++
          ) {
            var o = n[s].split("="),
        ...
        0 === $(t.target).closest(".sidebar").length && (n = !1),
          ...
          t.isPropagationStopped() ||
            ...
            ($("#page-container").hasClass("page-sidebar-toggled") &&
              ((n = !0), $("#page-container").removeClass("page-sidebar-toggled")),
            $(window).width() <= 767 &&
              $("#page-container").hasClass("page-right-sidebar-toggled") &&
              ((n = !0), $("#page-container").removeClass("page-right-sidebar-toggled")));
      }),
    ...
    if (
      ($(document).on("click", '.theme-panel [data-click="theme-selector"]', function () {
        ...
        0 === $("#theme-css-link").length
          ? $("head").append('<link href="' + t + '" rel="stylesheet" id="theme-css-link" />')
      ...
      t && $('.theme-panel [data-click="theme-selector"][data-theme="' + t + '"]').trigger("click"),
        e &&
          "navbar-inverse" == e &&
          $('.theme-panel [name="header-inverse"]').prop("checked", !0).trigger("change"),
        "true" == i &&
          $('.theme-panel [name="sidebar-grid"]').prop("checked", !0).trigger("change"),
        "true" == n &&
          $('.theme-panel [name="sidebar-gradient"]').prop("checked", !0).trigger("change"),
        "false" == s &&
          $('.theme-panel [name="sidebar-fixed"]').prop("checked", !1).trigger("change"),
        "false" == o &&
          $('.theme-panel [name="header-fixed"]').prop("checked", !1).trigger("change");
    }
  },
    ...
    function e(t, e) {
      ...
      switch (
        ...
        case "prev":
          ...
          (a =
            (l = -s) <= o
              ? ($(i).find(".menu-control.menu-control-left").removeClass("show"), 0)
              : l - o + 88),
            "rtl" != $("body").css("direction")
              ? $(i).animate({ marginLeft: "-" + a + "px" }, 150, function () {
          ...
          progress: function () {
            ...
            if (
              ...
              $("#float-sub-menu").css({ top: "auto", bottom: 0 }),
                $("#float-sub-menu-arrow").css({ top: "auto", bottom: a + "px" }),
            ...
            if ($("#page-container").hasClass("page-sidebar-minified")) {
              ...
              if (e) {
                ...
                if (
                  ...
                  $("#float-sub-menu").css({ top: o, left: r, bottom: "auto", right: a }),
                    $("#float-sub-menu-arrow").css({ top: "20px", bottom: "auto" }),
                    $("#float-sub-menu-line").css({ top: "20px", bottom: "auto" });
                else {
                  $("#float-sub-menu").css({ bottom: 0, top: "auto", left: r, right: a });
                  var h = l - o - 21;
                  $("#float-sub-menu-arrow").css({ top: "auto", bottom: h + "px" }),
  ...
  handleAjaxMode = function (h) {
    ...
    function e(t, e, i) {
      ...
      e &&
        ...
        (targetDataDataType = $(e).attr("data-data-type") ? $(e).attr("data-data-type") : l)),
        $.ajax({
          url: r,
          type: a,
          dataType: l,
